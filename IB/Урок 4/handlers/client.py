...
translates_btn = [['play', 'tenis', 'likes', 'he', 'to'], ['?', 'doing', 'are', 'now', 'what', 'you'], ['to', 'been', 'have', 'Paris', 'never', 'I']]
...
async def translate_click_words(callback_query: types.CallbackQuery):
...
def register_handlers_client(dp: Dispatcher):
    ...
    dp.register_message_handler(testing, content_types=['text'])
    ...
    dp.register_callback_query_handler(translate_click_words, lambda x: x.data in translates_eng[order_tr])
